function passage_check_info = passageCheckAnalysisWithShapes(obs_num, test_num)
    ...
    for test_idx = 1 : test_num    
        obs_array = generateObstacles(obs_num, x_map_limit, y_map_limit);
...
%%
function obs_array = generateObstacles(obs_num, x_map_limit, y_map_limit)
    for i = 1 : obs_num
       cur_x = rand();
       cur_y = rand();
       ...
       rotated_obs_pos = cur_rotz * std_obs_pos;
