...
valid_passage_pair = extendedVisibilityCheck(obs_array);
...
for i = 1 : valid_passage_num
    ...
    plot([obs_center(obsIdx1, 1), obs_center(obsIdx2, 1)], ...
         [obs_center(obsIdx1, 2), obs_center(obsIdx2, 2)])
end
axis('equal')
...
%% 
function validPassagePair = simpleVisibilityCheck(obsArray)
    
end
%%
function valid_passage_pair = extendedVisibilityCheck(obs_array)
    valid_passage_pair = [];
    ...
    for i = 1 : obs_num - 1
        for j = i + 1 : obs_num
            ...
            passage_center = [x_d_min_pair(1, 1) + x_d_min_pair(1, 2), ...
                              y_d_min_pair(1, 1) + y_d_min_pair(1, 2)] / 2;
