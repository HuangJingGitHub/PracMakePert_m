...
% 2D control points
% controlPts = [0.10,  0.7, 2.4,  4.0, 4.95, 4.80, 3.3, 2.20, 0.9, 0.00, 0.10;
%               0.50, -0.06, 0.6, -0.1, 0.80, 1.70, 2.2, 2.20, 1.8, 1.30, 0.50];
controlPts = [0.20, 0.60, 1.65, 2.15, 3.15, 4.20, 5.00, 4.60, 3.15, 1.90, 0.50, -0.10, 0.20;
              0.50, 0.10, 0.50, 0.20, 0.75, 0.45, 0.90, 1.90, 2.20, 2.10, 1.70,  1.30, 0.50] + [0.05; 0];
