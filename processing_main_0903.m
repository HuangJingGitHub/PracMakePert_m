...
%% read file
fileID = fopen('planned_path_pt_1_2021-9-3_16_27.txt', 'r');
...
fclose(fileID);
fileID = fopen('planned_path_pt_2_2021-9-3_16_27.txt', 'r');
pathData = fscanf(fileID, '%f');
pathSampleNum = size(pathData, 1) / 2;
...
fclose(fileID);
fileID = fopen('planned_path_pt_3_2021-9-3_16_27.txt', 'r');
pathData = fscanf(fileID, '%f');
pathSampleNum = size(pathData, 1) / 2;
...
%% plot 1
fig1 = figure('position', [500 500 640 380]);
img = imread("./Background Images/exp_snip_0903_1629_640x380.png");
image('CData', img, 'XData', [0, 640], 'YData', [0, 380])
hold on
...
hold on
startPt = plot(pathDataXYPt1(1,1), pathDataXYPt1(2,1), '-o', 'MarkerSize', 6,...
    'MarkerEdgeColor','r',...
    'MarkerFaceColor','r');
startPt.Annotation.LegendInformation.IconDisplayStyle = 'off';
hold on
targetPt = plot(pathDataXYPt1(1,end), pathDataXYPt1(2,end), '-o', 'MarkerSize', 6,...
    'MarkerEdgeColor','g',...
    'MarkerFaceColor','g');
...
hold on
plot(feedbackPt(3, :), feedbackPt(4, :), 'Color', 'g', 'LineWidth', 2)
hold on
startPt = plot(pathDataXYPt2(1,1), pathDataXYPt2(2,1), '-o', 'MarkerSize', 6,...
    'MarkerEdgeColor','r',...
    'MarkerFaceColor','r');
startPt.Annotation.LegendInformation.IconDisplayStyle = 'off';
hold on
targetPt = plot(pathDataXYPt2(1,end), pathDataXYPt2(2,end), '-o', 'MarkerSize', 6,...
    'MarkerEdgeColor','g',...
    'MarkerFaceColor','g');
targetPt.Annotation.LegendInformation.IconDisplayStyle = 'off';
...
hold on
plot(feedbackPt(5, :), feedbackPt(6, :), 'Color', 'g', 'LineWidth', 2)
hold on
startPt = plot(pathDataXYPt3(1,1), pathDataXYPt3(2,1), '-o', 'MarkerSize', 6,...
    'MarkerEdgeColor','r',...
    'MarkerFaceColor','r');
startPt.Annotation.LegendInformation.IconDisplayStyle = 'off';
hold on
targetPt = plot(pathDataXYPt3(1,end), pathDataXYPt3(2,end), '-o', 'MarkerSize', 6,...
    'MarkerEdgeColor','g',...
    'MarkerFaceColor','g');
targetPt.Annotation.LegendInformation.IconDisplayStyle = 'off';
legend('Reference Path', 'Real Path', 'Fontsize', 14)
text(pathDataXYPt1(1,1), pathDataXYPt1(2, 1) + 16, 's_0', 'Fontname', 'Arial', 'Fontsize', 14, 'Color', [1, 1, 1])
text(pathDataXYPt2(1,1), pathDataXYPt2(2, 1) + 16, 's_1', 'Fontname', 'Arial', 'Fontsize', 14, 'Color', [1, 1, 1])
text(pathDataXYPt3(1,1), pathDataXYPt3(2, 1) + 16, 's_2', 'Fontname', 'Arial', 'Fontsize', 14, 'Color', [1, 1, 1])
text(232, 64, 'obstacle', 'Fontname', 'Arial', 'Fontsize', 14, 'Color', [1, 1, 1])
...
print(fig1, './Figure/PathTracking_Obs_0903_1629_background_image', '-depsc')
