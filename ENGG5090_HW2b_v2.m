...
C = [1 0 CoMHeight / (robotMass * gacl) 0 0 0;
     0 0 0 1 0 CoMHeight / (robotMass * gacl)];
...
boundary = [footprint_x footprint_x footprint_y footprint_y]'*1.3;
...
%     jerk = e * (-(Pu'*Pu + RQ_ratio * eye(2*N,2*N)) \ Pu' * (Px * x_0 -
%     Z_REF));   %%% Analytical solution for 2a
