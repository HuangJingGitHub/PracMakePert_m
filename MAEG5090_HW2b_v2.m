...
plot(timeSeries(N+1:end), pxy(1,:), 'LineWidth', 1.2)
hold on
plot(timeSeries, x_ref, 'Color', 'r', 'LineStyle', '--', 'LineWidth', 1.2)
xlabel('time (s)','Fontname','Times', 'FontSize', 12);
ylabel('x','Fontname','Times', 'FontSize', 12);
leng1 = legend('ZMP', 'bCoM');
...
leng2 = legend('ZMP', 'CoM');
set(leng2, 'Location', 'northeast', 'Orientation', 'horizontal');