...
% DO_control_pts = [0.92, 0;
%                   0,   1.05] * ... 
%                  [0.20, 0.60, 1.90, 3.70, 5.16, 5.27, 4.74, 3.70, 1.80, -0.25, 0.20;
%                   0.50, 0.02, 1.06, 0.15, 0.70, 1.40, 1.95, 1.45, 2.30, 1.10, 0.50] + [0.05; 0];
% DO_control_pts = [1.1, 0; 0, 1.06] *...
%                   [0.2, 0.8, 2.5, 4.2, 4.8, 2.5, 0.2, 0.8;
%                   1.4, 0.0, 1.0, 0.0, 1.4, 2.4, 1.4, 0.0] + [-0.2; -0.2];
...
hold on
% lend = legend('CM', 'DWCM', 'PCM', 'DWPCM', 'TOM', 'Location', 'Southwest');
% set(lend, 'Color', 'None', 'Box', 'Off', 'Fontsize', 18, 'NumColumns', 1)

t = plot(DO_contour_pts(1, :), DO_contour_pts(2, :), 'Color', 'b', 'LineWidth', 1.5);
t.Annotation.LegendInformation.IconDisplayStyle = 'off';
hold on

for i = 1 : size(s_0, 2)
    t = quiver(s_0(1, i), s_0(2, i), s_d(1, i) - s_0(1, i), s_d(2, i) - s_0(2, i), ...
...
%print(fig1, './Figure/Shape_4', '-depsc')
