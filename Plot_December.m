...
figN = figure('position', [400 400 1460 526]);
H11 = subplot(2,4,1);
set(H11, 'Position', [0.045 0.6222 0.182 0.3378])
...
set(gca, 'XTickLabel', xTickObj, 'Fontsize', 12)
ylabel('Path Err. (px)', 'Fontname', 'Times', 'Fontsize', 16)
xlabel('(a)', 'Fontname', 'Times', 'Fontsize', 16)
legend('Tracking error', 'Dist. to path', 'Fontname', 'Times', 'Fontsize', 13.5, 'Position', [0.105 0.895 0.1222 0.0890])
%set(gca, 'XTicklabel', [])
%grid on
xlim([0 23])

H12 = subplot(2,4,2);
set(H12, 'Position', [0.2861 0.6222 0.182 0.3378])
plot(timeSeries0626, pathLengthTracking0626, 'Linewidth', 2)
hold on
plot(timeSeries0626, absDisToTarget0626, 'LineWidth', 2)
xTickObj = get(gca, 'XTickLabel');
set(gca, 'XTickLabel', xTickObj, 'Fontsize', 12)
ylabel('Target Err. (px)', 'Fontname', 'Times', 'Fontsize', 16)
xlabel('(b)', 'Fontname', 'Times', 'Fontsize', 16)
legend('In planned path', 'In configuration space', 'Fontname', 'Times', 'Fontsize', 13.5, 'Position', [0.287 0.6355 0.1452 0.0884])
%set(gca, 'XTicklabel', []);
%grid on
xlim([0 23])
ylim([0 256])
...
H13 = subplot(2,4,3);
set(H13, 'Position', [0.5222 0.6222 0.182 0.3378])
plot(timeSeries0626, DOToObsDistance0626, 'Linewidth', 2)
hold on
plot(timeSeries0626, eeToObsDistance0626, 'Linewidth', 2)
xTickObj = get(gca, 'XTickLabel');
set(gca, 'XTickLabel', xTickObj, 'Fontsize', 12)
xlabel('(c)', 'Fontname', 'Times', 'Fontsize', 16)
ylabel('Obstacle Dist. (px)', 'Fontname', 'Times', 'Fontsize', 16)
legendObj = legend('DO-obstacle', 'ee-obstacle', 'Fontname', 'Times', 'Fontsize', 13.5, 'Position', [0.585 0.85 0.0952 0.0890]);
%grid on
xlim([0 23])

H21 = subplot(2,4,5);
set(H21, 'Position', [0.0450 0.1483 0.182 0.3378])
...
text(3.8, 28, {'Adjustment'; '    phase'}, 'Fontname', 'Arial', 'Fontsize', 13)
...
set(gca, 'XTickLabel', xTickObj, 'Fontsize', 12)
ylabel('Path Err. (px)', 'Fontname', 'Times', 'Fontsize', 16)
xlabel({'Time (s)'; '(e)'}, 'Fontname', 'Times', 'Fontsize', 16)
...
H22 = subplot(2,4,6);
set(H22, 'Position', [0.2861 0.1483 0.182 0.3378])
...
set(gca, 'XTickLabel', xTickObj, 'Fontsize', 12)
ylabel('Target Err. (px)', 'Fontname', 'Times', 'Fontsize', 16)
xlabel({'Time (s)'; '(f)'}, 'Fontname', 'Times', 'Fontsize', 16)
...
H23 = subplot(2,4,7);
set(H23, 'Position', [0.5222 0.1483 0.182 0.3378])
...
xTickObj = get(gca, 'XTickLabel');
set(gca, 'XTickLabel', xTickObj, 'Fontsize', 12)
xlabel({'Time (s)'; '(g)'}, 'Fontname', 'Times', 'Fontsize', 16)
ylabel('Obstacle Dist. (px)', 'Fontname', 'Times', 'Fontsize', 16)
...
H14 = subplot(2, 4, 4);
set(H14, 'Position', [0.765 0.6153 0.172 0.35])
...
H24 = subplot(2, 4, 8);
set(H24, 'Position', [0.77 0.1363 0.172 0.35])
...
ax.FontName = 'Times';
set(ax, 'Ydir', 'reverse')
xlabel({'x (px)'; '  (h)'}, 'Fontname', 'Times', 'Fontsize', 16)
%ylabel('y (px)', 'Fontname', 'Times', 'Fontsize', 15)
text(126, 270, -80, {'y (px)'}, 'Fontname', 'Times', 'Fontsize', 16)
zlabel('Local Path Width (px)', 'Fontname', 'Times', 'Fontsize', 16)
grid on
%axis equal
