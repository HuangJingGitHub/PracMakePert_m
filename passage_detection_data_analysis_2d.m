...
data_directory = '/home/jing/Documents/Scripts/Passage_Traversing_Optimal_Path_Planning/src/ptopp/src/data/passage_detection_2d';
file_list = dir(data_directory);

obs_num_step = 20;
obs_num_list = 20:obs_num_step:200;
obs_num_list = obs_num_list';
obs_num_size = size(obs_num_list, 1);
res = zeros(obs_num_size, 9); 
...
set(gca, 'FontSize', 18)
ylabel('Passage number', 'FontName', 'Arial', 'FontSize', 20);
xlabel('Obstacle number (fixed sizes)', 'FontName', 'Arial', 'FontSize', 20);
leg_1 = legend({'Passage regions', 'Passage segments'},'FontName', 'Arial', 'FontSize', 20, 'Location', 'northwest');
...
% print(fig_1, '../../img/Passage_Num_Obs_Num_Side_40_0409', '-depsc')
% print(fig_1, '../../img/Passage_Num_Obs_Num_Varying_Side_20-60_0409', '-depsc')
...
set(gca, 'FontSize', 18)
ylabel('Cell number', 'FontName', 'Arial', 'FontSize', 20);
xlabel('Obstacle number (fixed sizes)', 'FontName', 'Arial', 'FontSize', 20);
ax = gca;
ax.XGrid = 'off';
ax.YGrid = 'on';
...
% print(fig_2, '../../img/Cell_Num_Obs_Num_Side_40_0409', '-depsc')
% print(fig_2, '../../img/Cell_Num_Obs_Num_Varying_Side_20-60_0409', '-depsc')
